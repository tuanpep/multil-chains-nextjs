 ...
 */
export function shrinkToValue<T>(mayValue: T, params?: T extends AnyFn ? Parameters<T> : any[]): T extends AnyFn ? ReturnType<T> : T {
  return (typeof mayValue === 'function' ? mayValue(...(params ?? [])) : mayValue) as any
}
